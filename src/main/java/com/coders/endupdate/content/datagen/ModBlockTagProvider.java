...
public class ModBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(ModBlocks.NOLITE_BRICKS.get())
                ...
                .add(ModBlocks.NOLIUM_GEYSER.get())
        ...
        tag(BlockTags.MINEABLE_WITH_AXE)
                ...
                .add(ModBlocks.BECK_WOOD.get())
                .add(ModBlocks.BECK_PLANKS.get())
                .add(ModBlocks.BECK_STAIRS.get())
                .add(ModBlocks.BECK_SLAB.get())
                .add(ModBlocks.BECK_FENCE.get())
                .add(ModBlocks.BECK_FENCE_GATE.get())
                .add(ModBlocks.BECK_DOOR.get())
                .add(ModBlocks.BECK_TRAPDOOR.get())
                .add(ModBlocks.BECK_PRESSURE_PLATE.get())
                .add(ModBlocks.BECK_BUTTON.get())
                .add(ModBlocks.BECK_LOG.get());
