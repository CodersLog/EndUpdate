package com.coders.endupdate.content.worldgen.structureclasses;

import com.coders.endupdate.content.worldgen.EndUpdateStructures;
...
public class EndIslandStructures extends Structure {
    ...
    public StructureType<?> type() {
        return EndUpdateStructures.END_ISLAND_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}